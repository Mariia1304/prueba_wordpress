...
* [Hotel Booking & Elementor Integration](https://wordpress.org/plugins/mphb-elementor/) add-on that helps speed up the work with your hotel website.
* [Hotel Booking & Divi Integration](https://wordpress.org/plugins/mphb-divi/) add-on that integrates Divi theme with the MotoPress Hotel Booking plugin to modify content and styles visually via Divi builder.
...
Hotel Booking Lite plugin, Copyright (C) 2018, MotoPress https://motopress.com/
...
= 3.0.1, Oct 3 2018 =
* Improved implementation of content visibility option for Accomodation Types.
