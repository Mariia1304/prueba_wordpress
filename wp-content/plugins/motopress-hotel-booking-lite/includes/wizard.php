...
class Wizard {
	...
	public function start(){
		...
		$this->addBookingConfirmationPage( $checkoutPageId );
		$this->addBookingCancellationPage( $checkoutPageId );
		$this->addPaymentSuccessPage( $checkoutPageId );
	...
	public function addBookingConfirmationPage( $parentId ){
		$title	 = __( 'Booking Confirmed', 'motopress-hotel-booking' );
		$content = __( 'We are pleased to inform you that your reservation request has been received and confirmed.', 'motopress-hotel-booking' );
	...
	public function addPaymentSuccessPage( $parentId ){
		$title	 = __( 'Payment Success', 'motopress-hotel-booking' );
		$content = __( 'Thank you for your payment. Your transaction has been completed and a receipt for your purchase has been emailed to you.', 'motopress-hotel-booking' );
		$id		 = $this->createPage( $title, $content, $parentId );
		if ( !is_wp_error( $id ) ) {
